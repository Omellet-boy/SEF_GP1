...
static constexpr auto qt_meta_stringdata_ZN9SimulatorE = QtMocHelpers::stringData(
    "Simulator",
    "dataUpdated",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9SimulatorE[] = {
...
Q_CONSTINIT const QMetaObject Simulator::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9SimulatorE.offsetsAndSizes,
    qt_meta_data_ZN9SimulatorE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9SimulatorE_t,
        // Q_OBJECT / Q_GADGET
...
void Simulator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Simulator::*)();
            if (_q_method_type _q_method = &Simulator::dataUpdated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Simulator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9SimulatorE.stringdata0))
